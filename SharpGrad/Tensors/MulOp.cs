...
namespace SharpGrad.Tensors
{
        ...
        where TGrad : unmanaged, IFloatingPoint<TGrad>
    {
        ...
        public static void Apply(Index1D idx, ArrayView1D<TType, Stride1D.Dense> left, ArrayView1D<TType, Stride1D.Dense> right, ArrayView1D<TType, Stride1D.Dense> output)
            => output[idx] = ApplyCpu(left[idx], right[idx]);
