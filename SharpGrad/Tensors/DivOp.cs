...
{
    public class DivOp<TFrom, TTo> : IApplyOpTwo<TFrom, TTo>
    ...
    public class DivOp<TFrom, TTo, TGrad> : DivOp<TFrom, TTo>, IBackwardTwo<TFrom, TTo, TGrad>
        where TFrom : unmanaged, INumber<TFrom>
        where TTo : unmanaged, INumber<TTo>
        where TGrad : unmanaged, IFloatingPoint<TGrad>
    {
        ...
        {
            var (l, r) = DivOp<TFrom, TTo, TGrad>.BackwardCpu(grad[idx], right[idx], left[idx]);
            leftGrad[idx] += l;
            rightGrad[idx] += r;
        }
    }
